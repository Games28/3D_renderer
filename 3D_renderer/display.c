...
bool init_window(void) {
    ...
    int fullscreen_width = 800;
    int fullscreen_height = 600;

    window_width = fullscreen_width / 2;
    window_height = fullscreen_height / 2;

    // Create a SDL Window
    window = SDL_CreateWindow(NULL, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, fullscreen_width, fullscreen_height, SDL_WINDOW_BORDERLESS);
    if (!window) {
